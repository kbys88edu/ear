(() => {
  const dictionaries = {
    ...
    "1〜2小節の旋律を聴き、3つの譜例から正しい旋律を選びます。": "Listen to a one- or two-bar melody and choose the correct notation from three options.",
    ...
    "ここへドロップ": "Drop here",
    "未回答": "No answer",
    "5マスの正解": "Correct answers for the five boxes",
    "音階": "Scale",
    "主調も含め、5つの調名カードを中央の図に配置してください。": "Place the five key-name cards, including the tonic, in the center diagram.",
    "下の調名カードを中央の5マスへドラッグしてください。": "Drag the key-name cards below into the five boxes in the center.",
    "1か所": "One item",
    "図全体": "Full diagram",
    "三連符": "Triplets",
    "16分音符": "Sixteenths",
    ...
    "七和音": "Seventh chords",
    "応用": "Advanced",
    "三和音プリセットにしました。": "Triad preset selected.",
    "七和音プリセットにしました。": "Seventh-chord preset selected.",
    "応用プリセットにしました。": "Advanced preset selected.",
...
,
    ...
    "1〜2小節の旋律を聴き、3つの譜例から正しい旋律を選びます。": "Écouter une mélodie d’une ou deux mesures et choisir la bonne notation parmi trois propositions.",
    "Browser-based materials for practicing intervals, chords, chord progressions, melodic dictation, minor scales, related keys, modes, key signatures, and rhythm. Each page supports mobile layout, result logs, and PDF export.": "Matériel pour travailler dans le navigateur les intervalles, accords, progressions, dictées mélodiques, gammes mineures, tonalités voisines, modes, armures et rythmes. Chaque page est adaptée au mobile et propose un historique ainsi qu’un export PDF.",
    "This page is currently in beta. It is being adjusted as a prototype tool for lessons and teaching materials, so display, notation, and audio playback may change.": "Cette page est actuellement en version bêta. Elle est ajustée comme outil pédagogique et prototype pour les cours ; l’affichage, la notation et la lecture audio peuvent encore évoluer.",
    "Ear-training and theory tools designed to be used alongside lessons.": "Outils de formation auditive et de théorie à utiliser en complément des cours.",
    "For private lessons in composition, music theory, solfège, DTM, and electroacoustic music, please visit the atelier composition son lesson page.": "Pour des cours individuels de composition, théorie musicale, solfège, MAO et musique électroacoustique, consultez la page des cours d’atelier composition son.",
    "Connect listening, reading, and composing through individual lessons": "Relier l’écoute, la lecture et la création par des cours individuels",
    "These tools are for self-practice. In lessons, harmony, solfège, composition, DTM, and electroacoustic music can be developed through assignments, corrections, and project work.": "Ces outils sont destinés à l’entraînement autonome. Pour étudier l’harmonie, le solfège, la composition, la MAO ou l’électroacoustique de manière structurée, les cours peuvent inclure des exercices, des corrections et un accompagnement de projet.",
    "Identify intervals from 2nds to 7ths in ascending, descending, and harmonic forms.": "Reconnaître les intervalles de la seconde à la septième, ascendants, descendants et harmoniques.",
    "Practice triads, seventh chords, advanced chords, arpeggiations, and inversions.": "Travailler les triades, accords de septième et accords avancés, en bloc, arpégés et renversés.",
    "Identify natural, harmonic, and melodic minor scales in ascending, descending, and up-down forms.": "Reconnaître les gammes mineures naturelle, harmonique et mélodique, ascendantes, descendantes et aller-retour.",
    "Given a tonic key, answer the parallel, subdominant, dominant, and relative keys.": "À partir d’une tonalité principale, répondre avec la tonalité homonyme, sous-dominante, dominante et relative.",
    "Identify modes through scales, short modal phrases, and tonic-drone phrases.": "Reconnaître les modes à partir de gammes, de courtes phrases modales et de phrases avec bourdon de tonique.",
    "Practice identifying keys from signatures and signatures from key names.": "S’exercer à identifier une tonalité à partir de l’armure, ou l’armure à partir du nom de la tonalité.",
    "Listen to a one-bar rhythm and choose the correct notation from three options.": "Écouter un rythme d’une mesure et choisir la bonne notation parmi trois propositions.",
    "Listen to a short chord progression and choose the correct Roman numerals from three options.": "Écouter une courte progression d’accords et choisir les bons chiffres romains parmi trois propositions.",
    "Listen to a one- or two-bar melody and choose the correct notation from three options.": "Écouter une mélodie d’une ou deux mesures et choisir la bonne notation parmi trois propositions.",
    "Real piano sounds, notation rendering, and PDF export use external CDN libraries. These tools are intended for use online.": "Les sons de piano, le rendu de partition et l’export PDF utilisent des bibliothèques CDN externes. Ces outils sont prévus pour une utilisation en ligne.",
    ...
    "主調": "Tonalité principale",
    "下属調": "Sous-dominante",
    "属調": "Dominante",
    "平行調": "Relative",
    "ここへドロップ": "Déposer ici",
    "未回答": "Sans réponse",
    "5マスの正解": "Réponses correctes des cinq cases",
    "音階": "Gamme",
    "主調も含め、5つの調名カードを中央の図に配置してください。": "Placez les cinq cartes de tonalité, y compris la tonalité principale, dans le diagramme central.",
    "下の調名カードを中央の5マスへドラッグしてください。": "Glissez les cartes de tonalité ci-dessous dans les cinq cases centrales.",
    "1か所": "Un élément",
    ...
    "応用": "Avancé",
    "三和音プリセットにしました。": "Préréglage triades sélectionné.",
    "七和音プリセットにしました。": "Préréglage accords de septième sélectionné.",
    "応用プリセットにしました。": "Préréglage avancé sélectionné.",
    ...
    "結果PDFを出力しました。": "PDF des résultats exporté.",
    "PDF作成中にエラーが発生しました。": "Une erreur est survenue pendant la création du PDF.",
...
,
  ...
  function translateNodeText(node, lang) {
    ...
    const source = String(node.__jpOriginal || raw).trim();
